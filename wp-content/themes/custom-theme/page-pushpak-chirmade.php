...
<div class="our-doc-p">
    ...
    <div class="row">
        <div class="col-md-6 pr-0">
            <img src="<?php bloginfo('template_directory') ?>/assets/images/doctors/Dr-Pushpak.webp" alt="" >
        </div>
        <div class="col-md-6 info">
            <div class="container mt-3">
                <h2 class="font-weight-bold">Dr. Pushpak Chirmade</h2>
                <p>
    ...
    <div class="heading mt-40">
        <h2 class="text-center"><span>About Dr. Pushpak Chirmade</span></h2>
    </div>
    <div class="container mt-20">
        <div class="col-md-12">
            <p class="text-justify">
                Dr. Pushpak Chirmade is associated with Mangal Anand Hospital from the last 1 year providing Medical Oncology Services.
            </p>
        </div>
    </div>
