...
function RefreshDoWidgetCode() {
    ...
    if(translation_method == 'on_fly' || translation_method == 'redirect' || translation_method == 'onfly') {
                ...
                if(jQuery(chklist+lang+':checked').length) {
                    ...
                    if(widget_look == 'flags' || widget_look == 'flags_dropdown' || widget_look == 'flags_name' || widget_look == 'flags_code') {
                        if(lang == 'en' && jQuery('#alt_us:checked').length)
                            widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/en-us'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="'+lang_name+'" />';
                        else if(lang == 'en' && jQuery('#alt_ca:checked').length)
                            widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/en-ca'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="'+lang_name+'" />';
                        else if(lang == 'pt' && jQuery('#alt_br:checked').length)
                            widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/pt-br'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="'+lang_name+'" />';
                        else if(lang == 'es' && jQuery('#alt_mx:checked').length)
                            widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/es-mx'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="'+lang_name+'" />';
                        else if(lang == 'es' && jQuery('#alt_ar:checked').length)
                            widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/es-ar'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="'+lang_name+'" />';
                        else if(lang == 'es' && jQuery('#alt_co:checked').length)
                            widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/es-co'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="'+lang_name+'" />';
                        else if(lang == 'fr' && jQuery('#alt_qc:checked').length)
                            widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/fr-qc'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="'+lang_name+'" />';
                        else
                            widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/'+lang+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="'+lang_name+'" />';
                    }
        ...
        if(widget_look == 'globe') {
            ...
            widget_preview += "$('.gsatelites').append('<span class=\"gsatelite gs' + (i + 1) + ' glang_' + language_codes2[i] + '\" onclick=\"doGTranslate("+"\\\\'"+default_language+"|'+language_codes2[i]+'"+"\\\\'"+")\" title=\"' + languages[i] + '\" style=\"background-image:url($wp_plugin_url/24/' + (function(l){if(l == 'en' && us_flag)return 'en-us';if(l == 'pt' && br_flag)return 'pt-br';if(l == 'es' && mx_flag)return 'es-mx';return l;})(language_codes2[i]) + '.webp);left:' + x + 'px;top:' + y + 'px;\"></span>');"+new_line;
        ...
        if(widget_look == 'popup') {
            ...
            if(default_language == 'en' && jQuery('#alt_us:checked').length)
                widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/en-us'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="en" /> <span>'+gt_lang_array[default_language]+'</span><span style="color:#666;font-size:8px;font-weight:bold;">&#9660;</span></a>'+new_line;
            else if(default_language == 'en' && jQuery('#alt_ca:checked').length)
                widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/en-ca'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="en" /> <span>'+gt_lang_array[default_language]+'</span><span style="color:#666;font-size:8px;font-weight:bold;">&#9660;</span></a>'+new_line;
            else if(default_language == 'pt' && jQuery('#alt_br:checked').length)
                widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/pt-br'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="pt" /> <span>'+gt_lang_array[default_language]+'</span><span style="color:#666;font-size:8px;font-weight:bold;">&#9660;</span></a>'+new_line;
            else if(default_language == 'es' && jQuery('#alt_mx:checked').length)
                widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/es-mx'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="es" /> <span>'+gt_lang_array[default_language]+'</span><span style="color:#666;font-size:8px;font-weight:bold;">&#9660;</span></a>'+new_line;
            else if(default_language == 'es' && jQuery('#alt_ar:checked').length)
                widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/es-ar'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="es" /> <span>'+gt_lang_array[default_language]+'</span><span style="color:#666;font-size:8px;font-weight:bold;">&#9660;</span></a>'+new_line;
            else if(default_language == 'es' && jQuery('#alt_co:checked').length)
                widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/es-co'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="es" /> <span>'+gt_lang_array[default_language]+'</span><span style="color:#666;font-size:8px;font-weight:bold;">&#9660;</span></a>'+new_line;
            else if(default_language == 'fr' && jQuery('#alt_qc:checked').length)
                widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/fr-qc'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="fr" /> <span>'+gt_lang_array[default_language]+'</span><span style="color:#666;font-size:8px;font-weight:bold;">&#9660;</span></a>'+new_line;
            else
                widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/'+default_language+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="'+default_language+'" /> <span>'+gt_lang_array[default_language]+'</span><span style="color:#666;font-size:8px;font-weight:bold;">&#9660;</span></a>'+new_line;
            ...
            jQuery.each(language_codes, function(i, val) {
                ...
                if(jQuery('#fincl_langs'+lang+':checked').length) {
                    ...
                    if(lang == 'en' && jQuery('#alt_us:checked').length)
                        widget_preview += '<img data-gt-lazy-src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/en-us'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="en" /> <span>'+lang_name+'</span></a>';
                    else if(lang == 'en' && jQuery('#alt_ca:checked').length)
                        widget_preview += '<img data-gt-lazy-src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/en-ca'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="en" /> <span>'+lang_name+'</span></a>';
                    else if(lang == 'pt' && jQuery('#alt_br:checked').length)
                        widget_preview += '<img data-gt-lazy-src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/pt-br'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="pt" /> <span>'+lang_name+'</span></a>';
                    else if(lang == 'es' && jQuery('#alt_mx:checked').length)
                        widget_preview += '<img data-gt-lazy-src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/es-mx'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="es" /> <span>'+lang_name+'</span></a>';
                    else if(lang == 'es' && jQuery('#alt_ar:checked').length)
                        widget_preview += '<img data-gt-lazy-src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/es-ar'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="es" /> <span>'+lang_name+'</span></a>';
                    else if(lang == 'es' && jQuery('#alt_co:checked').length)
                        widget_preview += '<img data-gt-lazy-src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/es-co'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="es" /> <span>'+lang_name+'</span></a>';
                    else if(lang == 'fr' && jQuery('#alt_qc:checked').length)
                        widget_preview += '<img data-gt-lazy-src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/fr-qc'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="fr" /> <span>'+lang_name+'</span></a>';
                    else
                        widget_preview += '<img data-gt-lazy-src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/'+lang+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="'+lang+'" /> <span>'+lang_name+'</span></a>';
        ...
        if(widget_look == 'dropdown_with_flags') {
            ...
            if(default_language == 'en' && jQuery('#alt_us:checked').length)
                widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/en-us'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="en" /> '+gt_lang_array[default_language]+'</a>'+new_line;
            else if(default_language == 'en' && jQuery('#alt_ca:checked').length)
                widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/en-ca'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="en" /> '+gt_lang_array[default_language]+'</a>'+new_line;
            else if(default_language == 'pt' && jQuery('#alt_br:checked').length)
                widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/pt-br'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="pt" /> '+gt_lang_array[default_language]+'</a>'+new_line;
            else if(default_language == 'es' && jQuery('#alt_mx:checked').length)
                widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/es-mx'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="es" /> '+gt_lang_array[default_language]+'</a>'+new_line;
            else if(default_language == 'es' && jQuery('#alt_ar:checked').length)
                widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/es-ar'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="es" /> '+gt_lang_array[default_language]+'</a>'+new_line;
            else if(default_language == 'es' && jQuery('#alt_co:checked').length)
                widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/es-co'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="es" /> '+gt_lang_array[default_language]+'</a>'+new_line;
            else if(default_language == 'fr' && jQuery('#alt_qc:checked').length)
                widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/fr-qc'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="fr" /> '+gt_lang_array[default_language]+'</a>'+new_line;
            else
                widget_preview += '<img src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/'+default_language+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="'+default_language+'" /> '+gt_lang_array[default_language]+'</a>'+new_line;
            ...
            jQuery.each(language_codes, function(i, val) {
                ...
                if(jQuery('#fincl_langs'+lang+':checked').length) {
                    ...
                    if(lang == 'en' && jQuery('#alt_us:checked').length)
                        widget_preview += '<img data-gt-lazy-src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/en-us'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="en" /> '+lang_name+'</a>';
                    else if(lang == 'en' && jQuery('#alt_ca:checked').length)
                        widget_preview += '<img data-gt-lazy-src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/en-ca'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="en" /> '+lang_name+'</a>';
                    else if(lang == 'pt' && jQuery('#alt_br:checked').length)
                        widget_preview += '<img data-gt-lazy-src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/pt-br'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="pt" /> '+lang_name+'</a>';
                    else if(lang == 'es' && jQuery('#alt_mx:checked').length)
                        widget_preview += '<img data-gt-lazy-src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/es-mx'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="es" /> '+lang_name+'</a>';
                    else if(lang == 'es' && jQuery('#alt_ar:checked').length)
                        widget_preview += '<img data-gt-lazy-src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/es-ar'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="es" /> '+lang_name+'</a>';
                    else if(lang == 'es' && jQuery('#alt_co:checked').length)
                        widget_preview += '<img data-gt-lazy-src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/es-co'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="es" /> '+lang_name+'</a>';
                    else if(lang == 'fr' && jQuery('#alt_qc:checked').length)
                        widget_preview += '<img data-gt-lazy-src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/fr-qc'+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="fr" /> '+lang_name+'</a>';
                    else
                        widget_preview += '<img data-gt-lazy-src="{$wp_plugin_url}/flags/'+(flag_style=='3d'&&flag_size||'svg')+'/'+lang+(flag_style=='3d'&&'.webp'||'.svg')+'" height="'+flag_size+'" width="'+flag_size+'" alt="'+lang+'" /> '+lang_name+'</a>';
                ...
                <div class="inside">
                    ...
                    <tr id="flag_style_option">
                        ...
                        <select id="flag_style"  name="flag_style" onchange="RefreshDoWidgetCode()">
                            <option value="3d" selected>3D (.webp)</option>
