...
<div class="our-doc-p">
    ...
    <div class="row">
        <div class="col-md-6 pr-0">
            <img src="<?php bloginfo('template_directory') ?>/assets/images/doctors/mangal-parihar-page.webp" alt="" >
        </div>
        <div class="col-md-6 info">
            <div class="container mt-3">
                <h2 class="font-weight-bold">Dr Mangal Parihar</h2>
                <p>
                    MS - Orthopaedics, MBBS <br>
                    Mangal Anand Hospital, Chembur, Mumbai
                </p>
                <h3>SPECIALITY</h3>
                <p class="mt-2"><span>Othopedist</span><span>Joint Replacement Surgeon</span><span>Deformity Correction</span><span> Limb Lengthening</span></p>
    ...
    <div class="heading mt-40">
        <h2 class="text-center"><span>About Dr. Mangal Parihar</span></h2>
    </div>
    <div class="container mt-20">
        <div class="col-md-12">
            ...
            <p class="text-justify">
                For the past many years, Dr. Parihar has dedicated his career to improving the lives of patients with limb disorders.
            </p>
            <p class="text-justify">
                He has performed numerous limb reconstruction surgeries using some of the most advanced surgical methods used for lengthening and deformity correction. He is the leading reconstruction orthopedic surgeon in the country and holds an acclaimed presence amongst his peers. He regularly receives referrals from across the country and overseas, for problems that have not resolved with conventional orthopedic surgery.
            </p>
