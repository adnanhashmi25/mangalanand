...
<div class="our-doc-p">
    ...
    <div class="row">
        ...
        <div class="col-md-6 info">
            <div class="container mt-3">
                <h2 class="font-weight-bold">Dr. Amit Patil</h2>
                <p>
    ...
    <div class="heading mt-40">
        <h2 class="text-center"><span>About Dr. Amit Patil</span></h2>
    </div>
    <div class="container mt-20">
        <div class="col-md-12">
            <p class="text-justify">
                Dr. Amit Patil has been associated with Mangal Anand Hospital for the last 7 years providing plastic and recosntructive services.
            </p>
        </div>
    </div>
