...
<div class="our-doc-p">
    <div class="row">
        ...
        <div class="col-md-6 info">
            <div class="container mt-3">
                <h2 class="font-weight-bold">Dr. Satish Chougale</h2>
                <p>
                    MD - Anesthesiology<br>
    ...
    <div class="heading mt-40">
        <h2 class="text-center"><span>About Dr. Satish Chougale</span></h2>
    </div>
    <div class="container mt-20">
        <div class="col-md-12">
            <p class="text-justify">Dr. Satish Chaugule has been associated with Mangal Anand Hospital from the last 20 years providing anesthesiology services, critical care services and pain management.</p>
        </div>
    </div>
