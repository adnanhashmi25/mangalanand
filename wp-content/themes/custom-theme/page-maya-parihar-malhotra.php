...
<div class="our-doc-p">
    ...
    <div class="row">
        <div class="col-md-6 pr-0">
            <img src="<?php bloginfo('template_directory') ?>/assets/images/doctor-banner/Dr-Maya-parihar.webp" alt="" >
        </div>
        <div class="col-md-6 info">
            <div class="container mt-3">
                <h2 class="font-weight-bold">Dr. Maya Parihar Malhotra</h2>
                <p>
                    MD - Pathology <br>
                    Mangal Anand Hospital, Chembur, Mumbai
                </p>
                <h3>SPECIALITY</h3>
                <p class="mt-2"><span>Pathology</span></p>
                ...
                <p class="mt-3">
                    <i class="fa fa-linkedin" aria-hidden="true"></i> &nbsp;<a href="https://in.linkedin.com/in/dr-maya-parihar-malhotra-b3930813">linkedin.com/in/dr-maya-parihar-malhotra-b3930813</a>
                </p>
                <p>
    ...
    <div class="heading mt-40">
        <h2 class="text-center"><span>About Dr. Maya Parihar Malhotra</span></h2>
    </div>
    <div class="container mt-20">
        <div class="col-md-12">
            <p class="text-justify">
                Head of the department Blood Bank Bombay Hospital
            </p>
