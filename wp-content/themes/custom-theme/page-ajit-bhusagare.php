...
<div class="our-doc-p">
    ...
    <div class="row">
        <div class="col-md-6 pr-0">
            <img src="<?php bloginfo('template_directory') ?>/assets/images/doctor-banner/Dr-Ajit-Bhusagare.webp" alt="" >
        </div>
        <div class="col-md-6 info">
            <div class="container mt-3">
                <h2 class="font-weight-bold">Dr. Ajit Bhusagare</h2>
                <p>
                    MS (Orthopedics), D. Orth <br>
    ...
    <div class="heading mt-40">
        <h2 class="text-center"><span>Dr. Ajit Bhusagare</span></h2>
    </div>
    <div class="container mt-20">
        <div class="col-md-12">
        <p class="text-justify">
        Dr. Ajit Bhusagare has been associated with Mangal Anand Hospital for the last one month treating knee pai, osteoarthritis and providing knee replacement related services
        </p>
