                    ...
                    <div class="state-box">
                        <div class="ofs" id="ofsh5">
                            <ul class="nav nav-tabs flex-column serv3a" id="myTab5" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link clr1" data-toggle="tab" href="#antima-jain" role="tab"
                                        aria-controls="antima-jain" aria-selected="false"> &nbsp; &nbsp; Dr. Antima Jain <i class="fas fa-arrow-right"></i></a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link clr4" data-toggle="tab" href="#sauramibika-tiwari" role="tab"
                                        aria-controls="sauramibika-tiwari" aria-selected="false"> &nbsp; &nbsp; Dr. Sauramibika Tiwari <i class="fas fa-arrow-right"></i></a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="state-box">
                        <div class="ofs">
                            <ul class="nav nav-tabs flex-column serv3c" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link clr2" data-toggle="tab" href="#antima-jain" role="tab"
                                        aria-controls="antima-jain" aria-selected="false"> &nbsp; &nbsp; Dr. Antima Jain <i class="fas fa-arrow-right"></i></a>
                                </li>
                            </ul>
                        </div> 
                    ...
                    <div class="state-box">
                        <div class="ofs" id="ofsh6">
                            <ul class="nav nav-tabs flex-column serv3a" id="myTab6" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link clr1" data-toggle="tab" href="#antima-jain1" role="tab"
                                        aria-controls="antima-jain" aria-selected="false"> &nbsp; &nbsp; Dr. Antima Jain <i class="fas fa-arrow-right"></i></a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link clr4" data-toggle="tab" href="#sauramibika-tiwari1" role="tab"
                                        aria-controls="sauramibika-tiwari" aria-selected="false"> &nbsp; &nbsp; Dr. Sauramibika Tiwari <i class="fas fa-arrow-right"></i></a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link clr1" data-toggle="tab" href="#sanjay-singh1" role="tab"
                                        aria-controls="sanjay-singh" aria-selected="false"> &nbsp; &nbsp; Dr. Dimple Chudgar<i class="fas fa-arrow-right"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="state-box">
                        <div class="ofs">
                            <ul class="nav nav-tabs flex-column serv3c" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link clr2" data-toggle="tab" href="#antima-jain1" role="tab"
                                        aria-controls="antima-jain" aria-selected="false"> &nbsp; &nbsp; Dr. Antima Jain <i class="fas fa-arrow-right"></i></a>
                                </li>
                            </ul>
                        </div> 
