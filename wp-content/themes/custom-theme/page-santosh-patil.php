...
<div class="our-doc-p">
    ...
    <div class="row">
        <div class="col-md-6 pr-0">
            <img src="<?php bloginfo('template_directory') ?>/assets/images/doctor-banner/Dr-Santosh-Patil.webp" alt="" >
        </div>
        <div class="col-md-6 info">
            <div class="container mt-3">
                <h2 class="font-weight-bold">Dr. Santosh Patil</h2>
                <p>
                    MS (Orthopedics)<br>
    ...
    <div class="heading mt-40">
        <h2 class="text-center"><span>Dr. Santosh Patil</span></h2>
    </div>
    <div class="container mt-20">
        <div class="col-md-12">
        <p class="text-justify">
            Dr. Santosh Patil is associated with Mangal Anand Hospital from the last 3 months providing services to joint replacement, complex trauma and spine patients.
        </p>
