...
<div class="our-doc-p">
    ...
    <div class="row">
        ...
        <div class="col-md-6 info">
            <div class="container mt-3">
                <h2 class="font-weight-bold">Dr. Devashri Patil</h2>
                <p>
                    MS - ENT, Fellowship in Head and Neck Surgical Oncology <br>
    ...
    <div class="heading mt-40">
        <h2 class="text-center"><span>About Dr. Devashri Patil</span></h2>
    </div>
    <div class="container mt-20">
        <div class="col-md-12">
            <p class="text-justify">
                Dr. Devashri Patil has been associated with Managal Anand Hospital for the last 1 year providing surgical treatment to head and neck cancers.
            </p>
        </div>
    </div>
