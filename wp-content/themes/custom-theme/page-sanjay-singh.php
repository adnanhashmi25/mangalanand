...
<div class="our-doc-p">
    ...
    <div class="row">
        <div class="col-md-6 pr-0">
            <img src="<?php bloginfo('template_directory') ?>/assets/images/doctor-banner/Dr-Sanjay-Singh.webp" alt="" >
        </div>
        <div class="col-md-6 info">
            <div class="container mt-3">
                <h2 class="font-weight-bold">Dr. Sanjay Singh</h2>
                <p>
                    DNB (Orthopedics), Fellowship in Shoulder & Elbow<br>
                    Mangal Anand Hospital, Chembur, Mumbai
                </p>
                <h3>SPECIALITY</h3>
                <p class="mt-2"><span>Shoulder & Elbow Surgery</span></p>
    ...
    <div class="container mt-20">
        <div class="col-md-12">
            ...
            Dr. Sanjay Singh has been associated with Mangal Anand Hospital for the last 1 month providing Shoulder & Elbow related orthopedics services
            </p>
