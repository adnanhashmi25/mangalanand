...
<div class="our-doc-p">
    ...
    <div class="row">
        <div class="col-md-6 pr-0">
            <img src="<?php bloginfo('template_directory') ?>/assets/images/doctor-banner/Dr-Kanchan.webp" alt="" >
        </div>
        <div class="col-md-6 info">
            <div class="container mt-3">
                <h2 class="font-weight-bold">Dr. Kanchan Suvasia</h2>
                <p>
    ...
    <div class="heading mt-40">
        <h2 class="text-center"><span>About Dr. Kanchan Suvasia</span></h2>
    </div>
    <div class="container mt-20">
        <div class="col-md-12">
            <p class="text-justify">
                Dr. Kanchan Suvasia has been associated with Mangal Anand Hospital from the last 4 years providing physiotherapy services.
            </p>
        </div>
    </div>
