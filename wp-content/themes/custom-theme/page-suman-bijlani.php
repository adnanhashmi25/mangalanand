...
<div class="our-doc-p">
    ...
    <div class="row">
        ...
        <div class="col-md-6 info">
            <div class="container mt-3">
                <h2 class="font-weight-bold">Dr. Suman Bijlani</h2>
                <p>
                    MBBS, MD - Obstetrics & Gynaecology, DGO, FCPS - Mid. & Gynae<br>
                    Mangal Anand Hospital, Chembur, Mumbai
                </p>
                <h3>SPECIALITY</h3>
                <p class="mt-2"><span>Gynecologist</span></p>
    ...
    <div class="heading mt-40">
        <h2 class="text-center"><span>About Dr. Suman Bijlani</span></h2>
    </div>
