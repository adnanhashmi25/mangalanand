...
<div class="our-doc-p">
    ...
    <div class="row">
        ...
        <div class="col-md-6 info">
            <div class="container mt-3">
                <h2 class="font-weight-bold">Dr. Preeti Jobalia</h2>
                <p>
                    DGO - Obstetrics & Gynecology<br>
    ...
    <div class="heading mt-40">
        <h2 class="text-center"><span>About Dr. Preeti Jobalia</span></h2>
    </div>
    <div class="container mt-20">
        <div class="col-md-12">
            <p class="text-justify">
                Dr. Preeti Jobalia has been associated with Mangal Anand Hospital from the last 6 months providing obstetrics and gynecology services.
            </p>
        </div>
    </div>
