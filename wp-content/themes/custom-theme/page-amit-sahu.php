...
<div class="our-doc-p">
    ...
    <div class="row">
        <div class="col-md-6 pr-0">
            <img src="<?php bloginfo('template_directory') ?>/assets/images/doctor-banner/Dr-Amit-Sahu.webp" alt="" >
        </div>
        <div class="col-md-6 info">
            <div class="container mt-3">
                <h2 class="font-weight-bold">Dr. Amit Sahu</h2>
                <p>
    ...
    <div class="heading mt-40">
        <h2 class="text-center"><span>About Dr. Amit Sahu</span></h2>
    </div>
    <div class="container mt-20">
        <div class="col-md-12">
            <p class="text-justify">
                Dr. Amit Sahu has been associated with Mangal Anand Hospital for providing interventional radiology, and vascular services.
            </p>
        </div>
    </div>
